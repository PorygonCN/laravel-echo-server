...
/**
 *
 * Laravel Echo Server Default Config
 *
 */
...
return [
    ...
    /****************************************************************
     *
     * those are some config not suggest to change
     *
     ***************************************************************/

    "socketIO" => Porygon\LaravelEchoServer\PHPSocketIO\SocketIO::class,
    "engine"   => Porygon\LaravelEchoServer\PHPSocketIO\Engine\Engine::class,

    "channel"          => Porygon\LaravelEchoServer\Channels\Channel::class,
    "private_channel"  => Porygon\LaravelEchoServer\Channels\PrivateChannel::class,
    "presence_channel" => Porygon\LaravelEchoServer\Channels\PresenceChannel::class,

    "polling_api" => Porygon\LaravelEchoServer\PHPSocketIO\Engine\Transports\PollingApi::class
];
